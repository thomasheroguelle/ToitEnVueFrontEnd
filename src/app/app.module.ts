...
@NgModule({
  declarations: [AppComponent, HomePageComponent, OpenstreetmapComponent, MapPageComponent, ToggleViewComponent, HousingListPageComponent, HousingCardComponent, FilterByHousingComponent, HousingListComponent, GoBackComponent, HousingDetailPageComponent, BookingComponent, GetHousingByIdComponent, HousingCreatePageComponent, CreateHousingFormComponent, SuccessPageComponent, RegistrationPageComponent, LoginPageComponent, UserProfilePageComponent, UserHousingPageComponent, UserHousingComponent, TermsOfUseComponent, TermsOfUsePageComponent, PrivacyPolicyPageComponent, PrivacyPolicyComponent, HeaderComponent, FooterComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    MatToolbarModule,
